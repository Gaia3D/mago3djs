...
var MagoPolylineGround = function(position, style) 
{
	...
	this.vboThickLinesByGeoCoords; // used to clampToTerrain. VBO by geoCoords.
...
MagoPolylineGround.prototype.getVBOThickLinesByGeoCoords = function(magoManager, options)
{
	...
	{
		this.vboThickLinesByGeoCoords = GeographicCoordsList.getVBOThickLines(magoManager, geoCoordsArray, undefined, options);
	}

	return this.vboThickLinesByGeoCoords;
};
