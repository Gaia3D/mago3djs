 ...
 * @constructor
 */
var TenelevenExtrudeWorkerManager = function(workersManager) 
{
	if (!(this instanceof TenelevenExtrudeWorkerManager)) 
	{
...
TenelevenExtrudeWorkerManager.prototype.isBusy = function () 
{
...
TenelevenExtrudeWorkerManager.prototype.doExtrude = function (data) 
{
	...
	if (!this.workerExtrudeObjects)
	{
		...
		this.workerExtrudeObjects = createWorker(magoManager.config.scriptRootPath + 'Worker/workerTenElevenExtrudeObjects.js');
...
TenelevenExtrudeWorkerManager.prototype.getResult = function (guid)
{
