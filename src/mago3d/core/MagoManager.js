...
MagoManager.prototype.startRender = function(scene, isLastFrustum, frustumIdx, numFrustums) 
{
	...
	if (!this.isCameraMoving && !this.mouseLeftDown && !this.mouseMiddleDown)
	{
		...
		this.prepareVisibleOctreesSortedByDistanceLOD2(gl, this.visibleObjControlerOctrees, fileRequestExtraCount); 
...
MagoManager.prototype.getRenderablesDetailedNeoBuildingAsimetricVersion = function(gl, node, visibleObjControlerOctrees, lod) 
{
	...
	else 
	{
		...
		//var keepFar = this.myCameraRelative.frustum.far;
		//this.myCameraRelative.frustum.far = distLod0;
 ...
 * @param {any} neoBuilding 
 */
MagoManager.prototype.prepareVisibleOctreesSortedByDistanceLOD2 = function(gl, globalVisibleObjControlerOctrees, fileRequestExtraCount) 
{
...
MagoManager.prototype.renderGeometry = function(gl, cameraPosition, shader, renderTexture, ssao_idx, visibleObjControlerNodes) 
{
	...
	if (ssao_idx === 1) 
	{
		...
		if (nodesLOD0Count > 0)
		{
			...
			if (MagoConfig.getPolicy().geo_light_specular_enable === "false")
