...
var f4d_Shader = function()
{
	...
	this._ModelViewProjectionMatrix = undefined;
...
f4d_ShadersManager.prototype.create_f4dDefaultShader = function(GL)
{
	...
	this.create_f4dStandardShaderWWW(GL);              // 3.***
	this.create_f4dTextureSimpleObjectA1Shader(GL);    // 4.***
};
...
f4d_ShadersManager.prototype.create_f4dStandardShaderWWW = function(GL)
{
	// Shader for WebWorldWind.**********************************
	// Shader for WebWorldWind.**********************************
	// This shader renders the normal f4d geometry.***
	var standard_shader = new f4d_Shader();
	this.shaders_array.push(standard_shader);
	...
	standard_shader.shader_fragment_source="\n\
		...
		// vec4 rotatedPos_2 = vec4(buildingPos.xyz, 1.0) + rotatedPos;\n\
	...
	standard_shader._ModelViewProjectionMatrix = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "ModelViewProjectionMatrix");
	standard_shader._ModelViewProjectionMatrixRelToEye = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "ModelViewProjectionMatrixRelToEye");
	standard_shader._RefTransfMatrix = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "RefTransfMatrix");
	//standard_shader._BuildingPos = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "buildingPos");
	standard_shader._BuildingPosHIGH = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "buildingPosHIGH");
	standard_shader._BuildingPosLOW = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "buildingPosLOW");
	standard_shader._encodedCameraPositionMCHigh = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "encodedCameraPositionMCHigh");
	standard_shader._encodedCameraPositionMCLow = GL.getUniformLocation(standard_shader.SHADER_PROGRAM, "encodedCameraPositionMCLow");
