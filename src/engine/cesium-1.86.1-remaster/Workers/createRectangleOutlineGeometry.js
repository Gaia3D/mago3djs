...
define(['./when-229515d6', './Matrix2-f2da41d4', './GeometryOffsetAttribute-ff1e192c', './Transforms-5a906b9e', './ComponentDatatype-17b06483', './RuntimeError-ffe03243', './GeometryAttribute-6eae89e8', './GeometryAttributes-b253752a', './IndexDatatype-b10faa0b', './PolygonPipeline-45b3d6cf', './RectangleGeometryLibrary-4b2ec267', './combine-8ce3f24b', './WebGLConstants-4e26b85a', './EllipsoidRhumbLine-afd6cd20'], (function (when, Matrix2, GeometryOffsetAttribute, Transforms, ComponentDatatype, RuntimeError, GeometryAttribute, GeometryAttributes, IndexDatatype, PolygonPipeline, RectangleGeometryLibrary, combine, WebGLConstants, EllipsoidRhumbLine) { 'use strict';
