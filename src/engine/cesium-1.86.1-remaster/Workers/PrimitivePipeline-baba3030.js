...
define(['exports', './Transforms-5a906b9e', './ComponentDatatype-17b06483', './when-229515d6', './RuntimeError-ffe03243', './Matrix2-f2da41d4', './GeometryAttribute-6eae89e8', './GeometryAttributes-b253752a', './GeometryPipeline-f3fce581', './IndexDatatype-b10faa0b', './WebMercatorProjection-d69cec15'], (function (exports, Transforms, ComponentDatatype, when, RuntimeError, Matrix2, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) { 'use strict';
  ...
  function geometryPipeline(parameters) {
    ...
    for (i = 0; i < length; ++i) {
      if (when.defined(instances[i].geometry)) {
        instances[i].geometry.primitiveType;
        break;
      }
    }
